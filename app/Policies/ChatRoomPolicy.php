...
class ChatRoomPolicy
{
    ...
    {
        return $user->hasPermission('view_chat_rooms');
    }
    ...
    {
        return $user->hasPermission('view_chat_rooms') || $user->hasPermission('view_all_data');
    }
    ...
    {
        return $user->hasPermission('create_chat_rooms');
    }
    ...
    {
        return $user->hasPermission('edit_chat_rooms');
    }
    ...
    {
        return $user->hasPermission('delete_chat_rooms');
    }
